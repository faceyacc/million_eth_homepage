...
function init(args, cb) {
  if (args._.length === 1) {
    return cb(new _errors.UserError(`usage: nwb init [${Array.from(_constants.PROJECT_TYPES).join('|')}] [name]`));
  }
  ...
  (0, _createProject.default)(args, projectType, name, process.cwd(), cb);
}
